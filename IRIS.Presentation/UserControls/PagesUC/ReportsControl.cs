    ...
    public partial class ReportsControl : UserControl
    {
        ...
        private void LoadTable()
        {
            try
            {
                ...
                // 2. Simply pass the list to your custom method
                if (lowStockControl != null)
                {
                    // This is the ONLY line you need. 
                    // All the DataGridView properties (DataSource, ReadOnly, etc.) must be removed.
        ...
        private void ConfigureCard(ReportCardsUC card, CardType type, IconChar icon, string value)
        {
