...
namespace IRIS.Presentation.UserControls.Components.Tables
{
    public partial class IngredientTableUC : UserControl
    {
        ...
        private readonly string[] _headers = { "Ingredient", "Category", "Stock", "Unit", "Min Threshold", "" };

        private readonly int _borderRadius = 15;
        private int _hoveredHeaderIndex = -1;

        private List<Ingredient> _allData = new List<Ingredient>();
        ...
        private void ApplyFilter(string query)
        {
            ...
            {
                var row = new IngredientRowUC(item)
                {
                    Width = rowWidth
                };
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                g.DrawString("Select Ingredient", titleFont, titleBrush, 30, 25);
            }
        }
        ...
        private void HeaderPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            using (Font font = new Font("Poppins", 9F, FontStyle.Bold))
            ...
            using (Brush bHover = new SolidBrush(_cIndigo))
            {
                ...
                for (int i = 0; i < _headers.Length; i++)
                {
                    ...
                    // Left align Name and Category, center everything else
                    var align = (i <= 1) ? fmtLeft : fmtCenter;
